...
for datasource in data_set_list:
    for systemName in system_name_list:
        ...
        # all_info_list = (tau_list, drop_list, relevant_count_list, recall_ratio_list, qrelsize_list)
            ...
            pool_depth_list = list(range(1, len(recall_infos[document_selection_type])+1))
        ...
        plt.xticks(pool_depth_list, pool_depth_list_names, fontsize = 5, rotation=45)
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_recall.pdf', format='pdf', orientation='landscape')
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_taus.pdf', format='pdf', orientation='landscape')
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_maxdrop.pdf', format='pdf', orientation='landscape')
