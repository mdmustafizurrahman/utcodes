...
document_selection_list = ['MAB_HIL_'+str(BUFFER_SIZE), 'DYN_MTF_HIL']
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_recall_budget_'+str(BUFFER_SIZE)+'_'+ str(rankMetric) +'.pdf', format='pdf', orientation='landscape')
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_taus_budget_'+str(BUFFER_SIZE)+'_'+ str(rankMetric) +'.pdf', format='pdf', orientation='landscape')
...
plt.tight_layout()
print plot_address
plt.savefig(plot_address + 'uqv_bandit_maxdrop_budget_'+str(BUFFER_SIZE)+'_'+ str(rankMetric) +'.pdf', format='pdf', orientation='landscape')
